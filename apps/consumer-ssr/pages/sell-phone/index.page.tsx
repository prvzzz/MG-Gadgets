...
function Page({ latestItems, otherItems }: { latestItems: Product[], otherItems: Product[] }) {
    ...
    return (<>
        ...
        <div className="grid place-content-center md:columns-2 max-sm:p-0 p-5 pt-10 max-sm:m-0 max-sm:rounded-none max-sm:columns-1 min-h-svh max-sm:min-h-96 max-sm:pt-10 " style={{ background: "linear-gradient(#ffffff, #e2e2e2)" }}>
            <div className="col-span-2 flex flex-col justify-evenly align-center p-10 max-sm:p-1.5 max-sm:pt-0 max-sm:pb-10" style={{ color: "black" }}>
                <h1
  className="text-7xl text-black max-sm:text-4xl font-bold max-sm:font-extrabold text-center animate-fade-up"
>
  Turn your mobile into instant cash today!
</h1>
            ...
            <div className="pl-3.5 pr-3.5 col-span-2 place-content-center min-md:m-auto">
                ...
                <div className="flex gap-3 md:justify-start justify-start max-sm:flex-col w-full pb-6 mt-8">
                    <a href="#latest" className="border-black text-black text-center min-md:w-fill bg-transparent hover:bg-white text-white-500 font-bold hover:text-black py-2 px-4 border border-white-500 hover:border-transparent rounded">
                        Explore now
                    </a>
                    <a href="#latest" className="border-black text-black text-center min-md:w-fill bg-transparent hover:bg-white text-white-500 font-bold hover:text-black py-2 px-4 border border-white-500 hover:border-transparent rounded">
                        Learn more
        ...
        <div className="custom_container">
            ...
            <div
                ...
                className="pt-2 pb-2 pl-2 h-fit flex flex-row justify-evenly m-auto align-items-center max-sm:grid max-sm:grid-cols-2">
            ...
            <br />
            <div className="w-fill md:columns-2 max-sm:p-0 p-5 pb-16 pt-10 m-1 mt-0 sm:columns-1 hidden" style={{ background: "linear-gradient(#ffffff, #3e3e3e)", borderRadius: "10px" }}>
                <div className="flex flex-col justify-evenly align-center p-10" style={{ color: "black" }}>
                    ...
                    <br /><br />
                    <ul>
                        <li style={{ display: "flex", alignItems: "center" }} className="text-white text-bold md:text-2xl max-sm:text-sm">
                            <FaStar style={{ marginRight: "10px" }} /> Easy mobile <span className="text-green-400 ">&nbsp;selling</span>
                        </li>
                        <li style={{ display: "flex", alignItems: "center" }} className="text-white text-bold md:text-2xl max-sm:text-sm">
                            <FaStar style={{ marginRight: "10px" }} /> Free <span className="text-green-400">&nbsp;Pickup&nbsp;</span> and <span className="text-green-400">&nbsp;Shipping&nbsp;</span>
        ...
        <div id="latest" className="custom_container">
            ...
            <div data-item-container="1" className="items_container flex flex-row w-full">
                {latestItems && latestItems.map((item: Product, ind) => {
                    return <div key={ind} className="grid-cols-1 mobile_card grid-rows-5">
                        ...
                        <div className="title">
                            ...
                            <a href={"/sell-phone/models/" + item.brand.name + "/" + item.alias}>
                        ...
                        <div className="pricing">
                            ...
                            <span className="discount_percent">-{Number(((item.max_retail_price - item.discount) / item.max_retail_price) * 100).toFixed(0)}% </span>
        ...
        <div className="custom_container">
            ...
            <span data-controller="1" className="fa-solid fa-angle-right"></span>
            <div data-item-container="1" className="items_container flex flex-row w-full">
                {otherItems && otherItems.map((item: Product, ind) => {
                    return <div key={ind} className="grid-cols-1 mobile_card grid-rows-5">
                        <img className="mgVerified" src={images.mg_verified} />
                        <img src={GLOBAL_CONSTANTS.s3Base + item.product_images[0] + ".png"} />
                        <div className="rating">
